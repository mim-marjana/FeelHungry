...
<nav class="navbar navbar-default navbar-dark2">
			...
			<ul class="right-nav">
	  		...
	  		<li class="user-nav">
	  			...
	  			<ul>
            		...
            		<li><a class="nav-1" href="{{route('logout')}}" onclick="event.preventDefault();
                	document.getElementById('logout-form').submit();"><span class="span"></span>Logout</a>
